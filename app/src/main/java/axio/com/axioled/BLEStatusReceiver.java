...
import axio.com.axioled.CommonFragments.ServiceDiscoveryFragment;
...
import axio.com.axioled.DataLoggerFragments.DataLoggerHistoryList;
import axio.com.axioled.OTAFirmwareUpdate.OTAFilesListingActivity;
import axio.com.axioled.OTAFirmwareUpdate.OTAFirmwareUpgradeFragment;
...
public class BLEStatusReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (BluetoothLeService.ACTION_GATT_DISCONNECTED.equals(action)) {
            Logger.e("onReceive--" + Settings.mApplicationInBackground);
            if (!Settings.mApplicationInBackground
                ...
                if (!ProfileScanningFragment.isInFragment &&
                        !ServiceDiscoveryFragment.isInServiceFragment&&!Settings.mApplicationInBackground) {
                    Logger.e("Not in PSF and SCF");
                    if (BluetoothLeService.getConnectionState() == BluetoothLeService.STATE_DISCONNECTED) {
                        Toast.makeText(context,
                                context.getResources().getString(R.string.alert_message_bluetooth_disconnect),
                                Toast.LENGTH_SHORT).show();
                        Intent homePage = new Intent(context, Settings.class);
