...
package axio.com.axioled.OTAFirmwareUpdate;
...
import axio.com.axioled.CommonUtils.TextProgressBar;
import axio.com.axioled.CommonUtils.Utils;
import axio.com.axioled.DataModelClasses.OTAFlashRowModel;
import axio.com.axioled.Settings;
...
//                                Logger.e("Checksum received>> " + checksumReceived);
    ...
    public void onClick(View view) {
        int id=view.getId();
            ...
            else if(id==R.id.ota_app_stack_comb) {
            ...
            else if(id==R.id.ota_app_stack_seperate) {
            ...
            else if(id==R.id.stop_upgrade_button) {
                showOTAStopAlert();
            }
    }
